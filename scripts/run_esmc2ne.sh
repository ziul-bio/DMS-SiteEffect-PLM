...
for dts in "${viral[@]}"
do
    echo "Fine-tuning esmc_300m on $dts:"                             
    python scripts/LitESMC_partial_trainer.py -i "data/DMS_mut_metadata/${dts}_metadata.csv" -o "experiments/fineTune/esmc_300m/${dts}.csv"  --checkpoint_path /stor/work/Wilke/wilkelab/pLMs_checkpoints/ESMC/esmc_300m_2024_12_v0.pth
