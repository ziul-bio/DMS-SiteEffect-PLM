...
# python scripts/reg_LassoCV.py -i embeddings/ESMC/esmc-300m/Zika_env_log2effect_Sourisseau2019_embeddings.pt -m data/DMS_mut_metadata/Zika_env_log2effect_Sourisseau2019_metadata.csv -o results/lassoCV/esmc_300M/Zika_env_log2effect_Sourisseau2019.csv    
