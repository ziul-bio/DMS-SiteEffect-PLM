...
class ClassificationHead(nn.Module):
    """Pre-norm style, giving stable training and better gradient flow in deep models.
    LayerNorm -> Dense -> Activation -> Dropout"""
...
if __name__ == '__main__':
    checkpoint_path = 'esm2_t33_650M_UR50D'
    dropout = 0.1
    lora_r = 8
    lora_alpha = 64 
    lora_dropout = 0.1
    ...
    model_loader = Load_from_pretrained(checkpoint_path, num_classes, dropout, lora_r, lora_alpha, lora_dropout, lora_modules)
