...
# python scripts/lassoCV_DBMut.py -e embeddings/esm2_150M/ProteinGym/doubles/A4_HUMAN_Seuma_2022.pt -m data/ProteinGym_metadata/doubles/A4_HUMAN_Seuma_2022.csv -o experiments/lassoCV_DBmut/esm2_150m/A4_HUMAN_Seuma_2022.csv    
...
def data_prep(path_compressed_embed_file, path_meta_data):
    ...
    meta_data = meta_data.query("ID != 'WT'")
...
def run_regression(meta_data, embed_df, ds_name):
    ...
    for fold, rep in enumerate([1], start=1):
        seed = make_seed(ds_name, rep)
        
        train, test = split_data(meta_data)
